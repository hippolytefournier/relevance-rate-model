...
| C12 | claim |  | The after-effect is the larger, so that the mismatch is strongest in the period that follows use and weaker, though more enduring, in its absence. | same window (13:00-13:30, calm): mismatch index after one 10-min session with no prior pattern > on the first day without use after 14 days of 16 x 10 min/day | after-effect 3.93 vs habitual 0.90 events/min | PASS |
